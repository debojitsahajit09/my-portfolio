...
export default function BioPage() {
  return (
    <main className="section" style={{ width: "100%", padding: "0 1.5rem" }}>
      ...
      {/* ----------------- SECTION 1: HERO / HEADER (WITH A BIT OF LEFT MARGIN) ----------------- */}
      <div style={{ 
        maxWidth: "900px", 
      ...
      {/* ----------------- REST OF THE CONTENT (CENTERED CONTAINER + LEFT ALIGNED TEXT) ----------------- */}
      <div style={{ 
        maxWidth: "800px", 
        margin: "0 auto", 
        textAlign: "left" 
        ...
        {/* ----------------- SCROLL ANIMATION ICON (CENTERED IN BODY) ----------------- */}
