  ...
  return (
    <main className="section min-h-screen py-10 px-4 md:px-8 max-w-6xl mx-auto">
      <div className="wrap">
        ...
        {/* Header Section Matching Experience Page */}
        <div className="mb-8">
        ...
        <div className="space-y-16 mt-12 max-w-4xl">
          ...
          <div className="space-y-4 text-muted-foreground text-base md:text-lg leading-relaxed">
            <p>
              I’m <strong className="text-emerald-500 font-semibold">Debojit Saha Jit</strong>, an independent researcher, robotics innovator, and HSC Science student at <strong className="text-emerald-500 font-semibold">Notre Dame College, Dhaka</strong>. My work bridges <strong className="text-emerald-500 font-semibold">robotics & embedded hardware design, biomedical research, grassroots STEM mentorship, and full-stack engineering</strong>.
            </p>

            <p>
              As the <strong className="text-emerald-500 font-semibold">Founder & Software Lead of Team C.A.R.E.</strong> and founder of the <strong className="text-emerald-500 font-semibold">Rajbari Robotics Association</strong>, my core drive is twofold: engineering intelligent hardware systems to build real-world autonomy for disabled individuals, and expanding robotics education to mentor thousands of young innovators across Bangladesh.
            </p>
          </div>

          <hr className="border-border my-8" />

          {/* Section: Core Philosophy & Purpose */}
          <section className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold">
              Core Philosophy & Purpose
            </h2>
            
            <div className="p-5 md:p-6 rounded-xl bg-card border-l-4 border-emerald-500 text-card-foreground text-sm md:text-base leading-relaxed space-y-3 shadow-sm">
              <p>
                Passionate about circuits and mechanics since early childhood, my engineering focus shifted deeply into <strong className="text-emerald-500 font-semibold">assistive technology and research</strong> when I observed firsthand the life-altering impacts of physical paralysis and mobility restriction.
              </p>
              <p>
                This led to founding <strong className="text-emerald-500 font-semibold">Team C.A.R.E.</strong> to prove that cutting-edge robotics—featuring gesture controls, IoT health monitoring, and offline AI voice interaction—can be engineered locally at a fraction of standard commercial costs.
              </p>
              <p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 md:p-6 rounded-2xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <div className="text-xs md:text-sm text-emerald-500/90 font-mono pt-1">
                  <strong>Stack:</strong> ESP32 · ESP8266 · Arduino · MPU6050 · BTS7960 Drivers · IoT Protocols
                </div>
              </div>
              ...
              <div className="p-5 md:p-6 rounded-2xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <div className="text-xs md:text-sm text-emerald-500/90 font-mono pt-1">
                  <strong>Tools:</strong> MATLAB · Simulink · ANSYS · Technical Writing · Zenodo
                </div>
              </div>
              ...
              <div className="p-5 md:p-6 rounded-2xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <div className="text-xs md:text-sm text-emerald-500/90 font-mono pt-1">
                  <strong>Tech:</strong> Next.js · React · HTML/CSS · PHP · SQL · Tailwind CSS
                </div>
              </div>
              ...
              <div className="p-5 md:p-6 rounded-2xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <div className="text-xs md:text-sm text-emerald-500/90 font-mono pt-1">
                  <strong>Tools:</strong> Photoshop · Illustrator · Premiere Pro · Figma
                </div>
              </div>
