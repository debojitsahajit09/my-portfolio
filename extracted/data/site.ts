  ...
  experience: [
    {
      ...
      org: "Team C.A.R.E.",
      text: "Leading low-cost assistive technology research and assistive wheelchair engineering."
    },
    {
      period: "Current",
      role: "Founder & Lead Mentor",
      org: "Rajbari Robotics Association",
      text: "Mentored over 3,000+ students for national and international competitions (WRO, IRO, IMO, IPhO)."
    },
    {
      period: "Current",
      role: "President — R&D Department",
      org: "Science Spark",
      text: "Leading research and development activities, experimentation and technical project collaboration."
    },
    {
      period: "Student",
      role: "Technical / Club Member",
      org: "Notre Dame IT Club",
      text: "Technology-focused extracurricular involvement."
    }
  ],
